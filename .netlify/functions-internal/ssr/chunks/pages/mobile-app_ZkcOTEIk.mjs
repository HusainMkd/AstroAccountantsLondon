import { d as createAstro, e as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead, F as Fragment, u as unescapeHTML } from '../astro_87-zhTjO.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$WidgetWrapper, a as $$Headline, e as $$Image, b as $$Button, l as $$Features3, k as $$Stats, c as $$Header, d as $$PageLayout } from './about_nV5-xbie.mjs';
import { b as $$Hero2, $ as $$CallToAction } from './click-through_R3w2ZfQy.mjs';
import { $ as $$Content, a as $$FAQs } from './index_eUyIknEx.mjs';
...
}, "/workspaces/AstroAccountantsLondon/src/components/widgets/Testimonials.astro", void 0);

const appStoreImg = new Proxy({"src":"/_astro/app-store.Ld7RuCc9.png","width":300,"height":89,"format":"png"}, {
...
const googlePlayImg = new Proxy({"src":"/_astro/google-play.CEkzHKSz.png","width":300,"height":89,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
}, "/workspaces/AstroAccountantsLondon/src/pages/homes/mobile-app.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/homes/mobile-app.astro";
