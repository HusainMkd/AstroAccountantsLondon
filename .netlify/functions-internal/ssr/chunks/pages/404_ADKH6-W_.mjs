...
import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_hVA3jZId.mjs';

async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../astro/assets-service_hVA3jZId.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "/workspaces/AstroAccountantsLondon/node_modules/astro/components/Image.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/squoosh","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///workspaces/AstroAccountantsLondon/dist/");
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/CommonMeta.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/Favicons.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/CustomStyles.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/ApplyColorMode.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);

const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/app-store.png": () => import('./mobile-app_ZkcOTEIk.mjs').then(n => n.a),"/src/assets/images/default.png": () => import('../default_-ycq-IHs.mjs'),"/src/assets/images/google-play.png": () => import('./mobile-app_ZkcOTEIk.mjs').then(n => n.g),"/src/assets/images/hero.png": () => import('../hero_lC7lo91g.mjs')});
  } catch (e) {
  }
  return images;
};
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/Metadata.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/SiteVerification.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/Analytics.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/common/BasicScripts.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/node_modules/astro/components/ViewTransitions.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html${addAttribute(language, "lang")}${addAttribute(textDirection, "dir")} class="2xl:text-[20px]"> <head>${renderComponent($$result, "CommonMeta", $$CommonMeta, {})}${renderComponent($$result, "Favicons", $$Favicons, {})}${renderComponent($$result, "CustomStyles", $$CustomStyles, {})}${renderComponent($$result, "ApplyColorMode", $$ApplyColorMode, {})}${renderComponent($$result, "Metadata", $$Metadata, { ...metadata })}${renderComponent($$result, "SiteVerification", $$SiteVerification, {})}${renderComponent($$result, "Analytics", $$Analytics, {})}<!-- Uncomment line below to activate View Transitions -->${renderComponent($$result, "ViewTransitions", $$ViewTransitions, { "fallback": "swap" })}${renderHead()}</head> <body class="antialiased text-default bg-page tracking-tight"> ${renderSlot($$result, $$slots["default"])} ${renderComponent($$result, "BasicScripts", $$BasicScripts, {})}  </body> </html>`;
}, "/workspaces/AstroAccountantsLondon/src/layouts/Layout.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/pages/404.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/404.astro";
const $$url = "/404";
...
export { $$Layout as $, APP_BLOG as A, BLOG_BASE as B, CATEGORY_BASE as C, I18N as I, METADATA as M, POST_PERMALINK_PATTERN as P, SITE as S, TAG_BASE as T, UI as U, _404 as _, getAsset as a, getPermalink as b, getBlogPermalink as c, getImage as d, getConfiguredImageService as e, findImage as f, getHomePermalink as g, cleanSlug as h, imageConfig as i, getFormattedDate as j, getCanonical as k, $$Image as l, trimSlash as t };
