...
}, "/workspaces/AstroAccountantsLondon/src/pages/landing/pre-launch.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/landing/pre-launch.astro";
