...
import { $ as $$Content } from './index_eUyIknEx.mjs';
import { f as $$Hero, g as $$Features2, d as $$PageLayout } from './about_nV5-xbie.mjs';
...
}, "/workspaces/AstroAccountantsLondon/src/pages/services.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/services.astro";
const $$url = "/services";
