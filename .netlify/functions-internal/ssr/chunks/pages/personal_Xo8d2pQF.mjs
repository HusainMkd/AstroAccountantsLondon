import { d as createAstro, e as createComponent, r as renderTemplate, i as renderComponent, F as Fragment, m as maybeRenderHead } from '../astro_87-zhTjO.mjs';
import 'kleur/colors';
import 'clsx';
import { f as $$Hero, l as $$Features3, c as $$Header, d as $$PageLayout } from './about_nV5-xbie.mjs';
import { $ as $$Content, b as $$Steps, c as $$BlogLatestPosts } from './index_eUyIknEx.mjs';
import { $ as $$CallToAction } from './click-through_R3w2ZfQy.mjs';
import { $ as $$Testimonials } from './mobile-app_ZkcOTEIk.mjs';
...
}, "/workspaces/AstroAccountantsLondon/src/pages/homes/personal.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/homes/personal.astro";
const $$url = "/homes/personal";

export { $$Personal as default, $$file as file, $$url as url };
