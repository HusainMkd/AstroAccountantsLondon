import { d as createAstro, e as createComponent, r as renderTemplate, i as renderComponent, m as maybeRenderHead, F as Fragment, u as unescapeHTML, k as renderSlot } from '../astro_87-zhTjO.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$WidgetWrapper, a as $$Headline, b as $$Button, c as $$Header, h as headerData, d as $$PageLayout, e as $$Image } from './about_nV5-xbie.mjs';
...
}, "/workspaces/AstroAccountantsLondon/src/components/widgets/CallToAction.astro", void 0);
...
const $$LandingLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PageLayout", $$PageLayout, { "metadata": metadata }, { "announcement": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "announcement" }, { "default": ($$result3) => renderTemplate` ${renderSlot($$result3, $$slots["announcement"])} ` })}`, "default": ($$result2) => renderTemplate`   ${renderSlot($$result2, $$slots["default"])} `, "header": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "header" }, { "default": ($$result3) => renderTemplate` ${renderSlot($$result3, $$slots["header"], renderTemplate` ${renderComponent($$result3, "Header", $$Header, { "links": headerData?.links[2] ? [headerData.links[2]] : void 0, "actions": [
    {
      text: "Call Now",
      href: "tel:+447762922925"
    }
  ], "showToggleTheme": true, "position": "right" })} `)} ` })}` })}`;
}, "/workspaces/AstroAccountantsLondon/src/layouts/LandingLayout.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/components/widgets/Hero2.astro", void 0);
...
}, "/workspaces/AstroAccountantsLondon/src/pages/landing/click-through.astro", void 0);

const $$file = "/workspaces/AstroAccountantsLondon/src/pages/landing/click-through.astro";
